...
##T-Test results
The T-Test results show that the p-value is 0.008805 which means that there is strong evidence against the hypthosis that the values would be related.  That means we can reject the hypothesis and claim there is no real strong correlation.
